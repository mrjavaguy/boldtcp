object DataModule1: TDataModule1
  ...
  object BoldModel1: TBoldModel
    ...
    Model = (
      ...
      #9'""'
        ...
        'lRoot,Bold.OptimisticLocking=<Default>,Bold.GenerateDefaultRegio' +
        'ns=True"'
      #9'(Classes'
      #9#9'(Class'
      #9#9#9'"New_ModelRoot"'
  ...
  object IBDatabase1: TIBDatabase
    DatabaseName = 'D:\Work\BoldTCP\src\client\UnitTests\UNITTESTSDB.GDB'
    Params.Strings = (
      'user_name=SYSDBA'
      'password=masterkey')
    LoginPrompt = False
  ...
  object BoldListHandle1: TBoldListHandle
    ...
    Expression = 'TestClass.allInstances'
    Left = 376
    Top = 40
  end
end
